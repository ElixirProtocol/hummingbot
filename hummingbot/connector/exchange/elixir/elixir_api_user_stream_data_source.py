...
from hummingbot.connector.exchange.elixir import elixir_constants as CONSTANTS, elixir_utils as utils
...
class ElixirAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        try:
            ...
            self.logger().info("Subscribed to private orders channels...")
