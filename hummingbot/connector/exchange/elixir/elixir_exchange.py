...
from hummingbot.connector.exchange.elixir import elixir_constants as CONSTANTS, elixir_web_utils as web_utils
from hummingbot.connector.exchange.elixir.elixir_api_order_book_data_source import ElixirAPIOrderBookDataSource
from hummingbot.connector.exchange.elixir.elixir_api_user_stream_data_source import ElixirAPIUserStreamDataSource
...
class ElixirExchange(ExchangePyBase):
    """
    ElixirExchange connects with elixir data feeds and provides order book pricing, user account tracking and
    ...
    @property
    def protocol_exchange(self):
        return self._client_config.elixir_protocol_exchange
    ...
    def _create_order_book_data_source(self) -> OrderBookTrackerDataSource:
        return ElixirAPIOrderBookDataSource(
            trading_pairs=self._trading_pairs,
            connector=self,
            api_factory=self._web_assistants_factory)

    def _create_user_stream_data_source(self) -> UserStreamTrackerDataSource:
        return ElixirAPIUserStreamDataSource(
            trading_pairs=self._trading_pairs,
            connector=self,
            api_factory=self._web_assistants_factory,
        )
